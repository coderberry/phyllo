...
# Unit tests for Phyllo::ContentList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentList1 do
  let(:instance) { Phyllo::ContentList1.new }

  describe "test an instance of ContentList1" do
    it "should create an instance of ContentList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentList1)
    end
  end
