...
# Unit tests for Phyllo::UserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::UserRequest do
  let(:instance) { Phyllo::UserRequest.new }

  describe 'test an instance of UserRequest' do
    it 'should create an instance of UserRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::UserRequest)
    end
  end
