...
# Unit tests for Phyllo::WorkExperience1Company
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkExperience1Company do
  let(:instance) { Phyllo::WorkExperience1Company.new }

  describe 'test an instance of WorkExperience1Company' do
    it 'should create an instance of WorkExperience1Company' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkExperience1Company)
    end
  end
