...
# Unit tests for Phyllo::Profile1EmailsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Profile1EmailsInner do
  let(:instance) { Phyllo::Profile1EmailsInner.new }

  describe 'test an instance of Profile1EmailsInner' do
    it 'should create an instance of Profile1EmailsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Profile1EmailsInner)
    end
  end
