...
# Unit tests for Phyllo::Account1DataIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Account1DataIdentity do
  let(:instance) { Phyllo::Account1DataIdentity.new }

  describe 'test an instance of Account1DataIdentity' do
    it 'should create an instance of Account1DataIdentity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Account1DataIdentity)
    end
  end
