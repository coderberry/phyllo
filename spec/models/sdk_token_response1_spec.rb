...
# Unit tests for Phyllo::SDKTokenResponse1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SDKTokenResponse1 do
  let(:instance) { Phyllo::SDKTokenResponse1.new }

  describe 'test an instance of SDKTokenResponse1' do
    it 'should create an instance of SDKTokenResponse1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::SDKTokenResponse1)
    end
  end

  describe 'test attribute "sdk_token"' do
    it 'should work' do
