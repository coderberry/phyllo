...
# Unit tests for Phyllo::PublishContentMedia2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PublishContentMedia2 do
  let(:instance) { Phyllo::PublishContentMedia2.new }

  describe "test an instance of PublishContentMedia2" do
    it "should create an instance of PublishContentMedia2" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::PublishContentMedia2)
    end
  end
