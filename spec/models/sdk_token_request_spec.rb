...
# Unit tests for Phyllo::SDKTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SDKTokenRequest do
  let(:instance) { Phyllo::SDKTokenRequest.new }

  describe 'test an instance of SDKTokenRequest' do
    it 'should create an instance of SDKTokenRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::SDKTokenRequest)
    end
  end
