...
# Unit tests for Phyllo::PublishContent1AdditionalInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PublishContent1AdditionalInfo do
  let(:instance) { Phyllo::PublishContent1AdditionalInfo.new }

  describe "test an instance of PublishContent1AdditionalInfo" do
    it "should create an instance of PublishContent1AdditionalInfo" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::PublishContent1AdditionalInfo)
    end
  end
