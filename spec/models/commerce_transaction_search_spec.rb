...
# Unit tests for Phyllo::CommerceTransactionSearch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceTransactionSearch do
  let(:instance) { Phyllo::CommerceTransactionSearch.new }

  describe "test an instance of CommerceTransactionSearch" do
    it "should create an instance of CommerceTransactionSearch" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceTransactionSearch)
    end
  end
