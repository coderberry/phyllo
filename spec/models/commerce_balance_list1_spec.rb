...
# Unit tests for Phyllo::CommerceBalanceList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalanceList1 do
  let(:instance) { Phyllo::CommerceBalanceList1.new }

  describe 'test an instance of CommerceBalanceList1' do
    it 'should create an instance of CommerceBalanceList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommerceBalanceList1)
    end
  end
