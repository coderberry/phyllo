...
# Unit tests for Phyllo::CommerceBalanceSearchList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalanceSearchList do
  let(:instance) { Phyllo::CommerceBalanceSearchList.new }

  describe "test an instance of CommerceBalanceSearchList" do
    it "should create an instance of CommerceBalanceSearchList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceBalanceSearchList)
    end
  end
