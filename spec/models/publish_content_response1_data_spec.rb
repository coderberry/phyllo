...
# Unit tests for Phyllo::PublishContentResponse1Data
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PublishContentResponse1Data do
  let(:instance) { Phyllo::PublishContentResponse1Data.new }

  describe "test an instance of PublishContentResponse1Data" do
    it "should create an instance of PublishContentResponse1Data" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::PublishContentResponse1Data)
    end
  end
  ...
  describe 'test attribute "status"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["READY", "SUCCESS", "FAILURE", "IN_PROGRESS"])
  ...
  describe 'test attribute "format"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["VIDEO", "AUDIO", "IMAGE", "TEXT", "COLLECTION"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "published_info"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
