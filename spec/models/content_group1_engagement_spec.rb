...
# Unit tests for Phyllo::ContentGroup1Engagement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroup1Engagement do
  let(:instance) { Phyllo::ContentGroup1Engagement.new }

  describe "test an instance of ContentGroup1Engagement" do
    it "should create an instance of ContentGroup1Engagement" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentGroup1Engagement)
    end
  end
