...
# Unit tests for Phyllo::ActivityContentSearch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityContentSearch do
  let(:instance) { Phyllo::ActivityContentSearch.new }

  describe 'test an instance of ActivityContentSearch' do
    it 'should create an instance of ActivityContentSearch' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ActivityContentSearch)
    end
  end
