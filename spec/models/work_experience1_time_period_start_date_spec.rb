...
# Unit tests for Phyllo::WorkExperience1TimePeriodStartDate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkExperience1TimePeriodStartDate do
  let(:instance) { Phyllo::WorkExperience1TimePeriodStartDate.new }

  describe "test an instance of WorkExperience1TimePeriodStartDate" do
    it "should create an instance of WorkExperience1TimePeriodStartDate" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WorkExperience1TimePeriodStartDate)
    end
  end
