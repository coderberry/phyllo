...
# Unit tests for Phyllo::ProfileList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ProfileList1 do
  let(:instance) { Phyllo::ProfileList1.new }

  describe 'test an instance of ProfileList1' do
    it 'should create an instance of ProfileList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ProfileList1)
    end
  end
