...
# Unit tests for Phyllo::SDKTokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SDKTokenResponse do
  let(:instance) { Phyllo::SDKTokenResponse.new }

  describe "test an instance of SDKTokenResponse" do
    it "should create an instance of SDKTokenResponse" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SDKTokenResponse)
    end
  end
