...
# Unit tests for Phyllo::WorkPlatformAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatformAttribute do
  let(:instance) { Phyllo::WorkPlatformAttribute.new }

  describe "test an instance of WorkPlatformAttribute" do
    it "should create an instance of WorkPlatformAttribute" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WorkPlatformAttribute)
    end
  end
