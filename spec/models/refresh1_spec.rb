...
# Unit tests for Phyllo::Refresh1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Refresh1 do
  let(:instance) { Phyllo::Refresh1.new }

  describe 'test an instance of Refresh1' do
    it 'should create an instance of Refresh1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Refresh1)
    end
  end
