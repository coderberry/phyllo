...
# Unit tests for Phyllo::WorkPlatformList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatformList1 do
  let(:instance) { Phyllo::WorkPlatformList1.new }

  describe 'test an instance of WorkPlatformList1' do
    it 'should create an instance of WorkPlatformList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatformList1)
    end
  end
