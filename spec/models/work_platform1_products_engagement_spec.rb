...
# Unit tests for Phyllo::WorkPlatform1ProductsEngagement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1ProductsEngagement do
  let(:instance) { Phyllo::WorkPlatform1ProductsEngagement.new }

  describe 'test an instance of WorkPlatform1ProductsEngagement' do
    it 'should create an instance of WorkPlatform1ProductsEngagement' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatform1ProductsEngagement)
    end
  end
