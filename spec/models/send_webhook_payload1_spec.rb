...
# Unit tests for Phyllo::SendWebhookPayload1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SendWebhookPayload1 do
  let(:instance) { Phyllo::SendWebhookPayload1.new }

  describe "test an instance of SendWebhookPayload1" do
    it "should create an instance of SendWebhookPayload1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SendWebhookPayload1)
    end
  end
