...
# Unit tests for Phyllo::WorkPlatform1ProductsPublish
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1ProductsPublish do
  let(:instance) { Phyllo::WorkPlatform1ProductsPublish.new }

  describe 'test an instance of WorkPlatform1ProductsPublish' do
    it 'should create an instance of WorkPlatform1ProductsPublish' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatform1ProductsPublish)
    end
  end
