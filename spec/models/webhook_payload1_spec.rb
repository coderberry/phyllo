...
# Unit tests for Phyllo::WebhookPayload1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WebhookPayload1 do
  let(:instance) { Phyllo::WebhookPayload1.new }

  describe "test an instance of WebhookPayload1" do
    it "should create an instance of WebhookPayload1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WebhookPayload1)
    end
  end
