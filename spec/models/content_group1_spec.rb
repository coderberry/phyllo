...
# Unit tests for Phyllo::ContentGroup1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroup1 do
  let(:instance) { Phyllo::ContentGroup1.new }

  describe 'test an instance of ContentGroup1' do
    it 'should create an instance of ContentGroup1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ContentGroup1)
    end
  end
  ...
  describe 'test attribute "format"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["VIDEO", "IMAGE", "AUDIO", "TEXT", "COLLECTION", "OTHER"])
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ALBUM", "PLAYLIST", "OTHER"])
      # validator.allowable_values.each do |value|
