...
# Unit tests for Phyllo::UserAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::UserAttribute do
  let(:instance) { Phyllo::UserAttribute.new }

  describe 'test an instance of UserAttribute' do
    it 'should create an instance of UserAttribute' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::UserAttribute)
    end
  end
