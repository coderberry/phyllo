...
# Unit tests for Phyllo::PublishContentResponse1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PublishContentResponse1 do
  let(:instance) { Phyllo::PublishContentResponse1.new }

  describe 'test an instance of PublishContentResponse1' do
    it 'should create an instance of PublishContentResponse1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::PublishContentResponse1)
    end
  end
