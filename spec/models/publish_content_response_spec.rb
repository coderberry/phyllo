...
# Unit tests for Phyllo::PublishContentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PublishContentResponse do
  let(:instance) { Phyllo::PublishContentResponse.new }

  describe 'test an instance of PublishContentResponse' do
    it 'should create an instance of PublishContentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::PublishContentResponse)
    end
  end
