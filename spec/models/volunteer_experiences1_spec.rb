...
# Unit tests for Phyllo::VolunteerExperiences1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::VolunteerExperiences1 do
  let(:instance) { Phyllo::VolunteerExperiences1.new }

  describe "test an instance of VolunteerExperiences1" do
    it "should create an instance of VolunteerExperiences1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::VolunteerExperiences1)
    end
  end
