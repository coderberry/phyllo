...
# Unit tests for Phyllo::WebhookResponseList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WebhookResponseList do
  let(:instance) { Phyllo::WebhookResponseList.new }

  describe "test an instance of WebhookResponseList" do
    it "should create an instance of WebhookResponseList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WebhookResponseList)
    end
  end
