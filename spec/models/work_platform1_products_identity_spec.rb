...
# Unit tests for Phyllo::WorkPlatform1ProductsIdentity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1ProductsIdentity do
  let(:instance) { Phyllo::WorkPlatform1ProductsIdentity.new }

  describe 'test an instance of WorkPlatform1ProductsIdentity' do
    it 'should create an instance of WorkPlatform1ProductsIdentity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatform1ProductsIdentity)
    end
  end
