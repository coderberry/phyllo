...
# Unit tests for Phyllo::WorkExperience1CompanyEmployeeCount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkExperience1CompanyEmployeeCount do
  let(:instance) { Phyllo::WorkExperience1CompanyEmployeeCount.new }

  describe 'test an instance of WorkExperience1CompanyEmployeeCount' do
    it 'should create an instance of WorkExperience1CompanyEmployeeCount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkExperience1CompanyEmployeeCount)
    end
  end
