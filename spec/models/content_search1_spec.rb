...
# Unit tests for Phyllo::ContentSearch1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentSearch1 do
  let(:instance) { Phyllo::ContentSearch1.new }

  describe 'test an instance of ContentSearch1' do
    it 'should create an instance of ContentSearch1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ContentSearch1)
    end
  end
