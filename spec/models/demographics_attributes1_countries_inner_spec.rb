...
# Unit tests for Phyllo::DemographicsAttributes1CountriesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::DemographicsAttributes1CountriesInner do
  let(:instance) { Phyllo::DemographicsAttributes1CountriesInner.new }

  describe "test an instance of DemographicsAttributes1CountriesInner" do
    it "should create an instance of DemographicsAttributes1CountriesInner" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::DemographicsAttributes1CountriesInner)
    end
  end
