...
# Unit tests for Phyllo::Education1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Education1 do
  let(:instance) { Phyllo::Education1.new }

  describe "test an instance of Education1" do
    it "should create an instance of Education1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Education1)
    end
  end
  ...
  describe 'test attribute "field_study"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
