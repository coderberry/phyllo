...
# Unit tests for Phyllo::CommerceBalanceSearchList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalanceSearchList1 do
  let(:instance) { Phyllo::CommerceBalanceSearchList1.new }

  describe 'test an instance of CommerceBalanceSearchList1' do
    it 'should create an instance of CommerceBalanceSearchList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommerceBalanceSearchList1)
    end
  end
