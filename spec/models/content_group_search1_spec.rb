...
# Unit tests for Phyllo::ContentGroupSearch1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroupSearch1 do
  let(:instance) { Phyllo::ContentGroupSearch1.new }

  describe "test an instance of ContentGroupSearch1" do
    it "should create an instance of ContentGroupSearch1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentGroupSearch1)
    end
  end
