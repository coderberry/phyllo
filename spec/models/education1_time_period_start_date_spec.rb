...
# Unit tests for Phyllo::Education1TimePeriodStartDate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Education1TimePeriodStartDate do
  let(:instance) { Phyllo::Education1TimePeriodStartDate.new }

  describe 'test an instance of Education1TimePeriodStartDate' do
    it 'should create an instance of Education1TimePeriodStartDate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Education1TimePeriodStartDate)
    end
  end
