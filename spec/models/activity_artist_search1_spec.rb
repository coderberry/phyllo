...
# Unit tests for Phyllo::ActivityArtistSearch1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityArtistSearch1 do
  let(:instance) { Phyllo::ActivityArtistSearch1.new }

  describe 'test an instance of ActivityArtistSearch1' do
    it 'should create an instance of ActivityArtistSearch1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ActivityArtistSearch1)
    end
  end
