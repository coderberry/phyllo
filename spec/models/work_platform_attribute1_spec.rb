...
# Unit tests for Phyllo::WorkPlatformAttribute1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatformAttribute1 do
  let(:instance) { Phyllo::WorkPlatformAttribute1.new }

  describe 'test an instance of WorkPlatformAttribute1' do
    it 'should create an instance of WorkPlatformAttribute1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatformAttribute1)
    end
  end
