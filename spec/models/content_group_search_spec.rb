...
# Unit tests for Phyllo::ContentGroupSearch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroupSearch do
  let(:instance) { Phyllo::ContentGroupSearch.new }

  describe 'test an instance of ContentGroupSearch' do
    it 'should create an instance of ContentGroupSearch' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ContentGroupSearch)
    end
  end
