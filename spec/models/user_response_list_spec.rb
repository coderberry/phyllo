...
# Unit tests for Phyllo::UserResponseList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::UserResponseList do
  let(:instance) { Phyllo::UserResponseList.new }

  describe 'test an instance of UserResponseList' do
    it 'should create an instance of UserResponseList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::UserResponseList)
    end
  end
