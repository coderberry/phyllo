...
# Unit tests for Phyllo::CommerceBalanceAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalanceAmount do
  let(:instance) { Phyllo::CommerceBalanceAmount.new }

  describe "test an instance of CommerceBalanceAmount" do
    it "should create an instance of CommerceBalanceAmount" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceBalanceAmount)
    end
  end
