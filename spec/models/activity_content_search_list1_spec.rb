...
# Unit tests for Phyllo::ActivityContentSearchList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityContentSearchList1 do
  let(:instance) { Phyllo::ActivityContentSearchList1.new }

  describe 'test an instance of ActivityContentSearchList1' do
    it 'should create an instance of ActivityContentSearchList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ActivityContentSearchList1)
    end
  end
