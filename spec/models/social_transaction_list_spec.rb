...
# Unit tests for Phyllo::SocialTransactionList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SocialTransactionList do
  let(:instance) { Phyllo::SocialTransactionList.new }

  describe "test an instance of SocialTransactionList" do
    it "should create an instance of SocialTransactionList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SocialTransactionList)
    end
  end
