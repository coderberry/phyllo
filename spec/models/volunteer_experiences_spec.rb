...
# Unit tests for Phyllo::VolunteerExperiences
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::VolunteerExperiences do
  let(:instance) { Phyllo::VolunteerExperiences.new }

  describe "test an instance of VolunteerExperiences" do
    it "should create an instance of VolunteerExperiences" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::VolunteerExperiences)
    end
  end
