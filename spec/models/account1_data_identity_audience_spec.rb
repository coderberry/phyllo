...
# Unit tests for Phyllo::Account1DataIdentityAudience
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Account1DataIdentityAudience do
  let(:instance) { Phyllo::Account1DataIdentityAudience.new }

  describe 'test an instance of Account1DataIdentityAudience' do
    it 'should create an instance of Account1DataIdentityAudience' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Account1DataIdentityAudience)
    end
  end
