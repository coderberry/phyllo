...
# Unit tests for Phyllo::Account1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Account1 do
  let(:instance) { Phyllo::Account1.new }

  describe 'test an instance of Account1' do
    it 'should create an instance of Account1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Account1)
    end
  end
