...
# Unit tests for Phyllo::CommercePayoutSearch1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommercePayoutSearch1 do
  let(:instance) { Phyllo::CommercePayoutSearch1.new }

  describe "test an instance of CommercePayoutSearch1" do
    it "should create an instance of CommercePayoutSearch1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommercePayoutSearch1)
    end
  end
