...
# Unit tests for Phyllo::Account1DataEngagement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Account1DataEngagement do
  let(:instance) { Phyllo::Account1DataEngagement.new }

  describe "test an instance of Account1DataEngagement" do
    it "should create an instance of Account1DataEngagement" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Account1DataEngagement)
    end
  end
