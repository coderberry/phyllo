...
# Unit tests for Phyllo::SocialTransactionSearchList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SocialTransactionSearchList1 do
  let(:instance) { Phyllo::SocialTransactionSearchList1.new }

  describe "test an instance of SocialTransactionSearchList1" do
    it "should create an instance of SocialTransactionSearchList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SocialTransactionSearchList1)
    end
  end
