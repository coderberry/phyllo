...
# Unit tests for Phyllo::ActivityArtist1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityArtist1 do
  let(:instance) { Phyllo::ActivityArtist1.new }

  describe "test an instance of ActivityArtist1" do
    it "should create an instance of ActivityArtist1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityArtist1)
    end
  end
  ...
  describe 'test attribute "platform_artist_id"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "activity_type"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["FOLLOWED", "TOP"])
