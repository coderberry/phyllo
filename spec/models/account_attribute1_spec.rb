...
# Unit tests for Phyllo::AccountAttribute1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::AccountAttribute1 do
  let(:instance) { Phyllo::AccountAttribute1.new }

  describe 'test an instance of AccountAttribute1' do
    it 'should create an instance of AccountAttribute1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::AccountAttribute1)
    end
  end
