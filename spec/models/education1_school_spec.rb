...
# Unit tests for Phyllo::Education1School
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Education1School do
  let(:instance) { Phyllo::Education1School.new }

  describe 'test an instance of Education1School' do
    it 'should create an instance of Education1School' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Education1School)
    end
  end
