...
# Unit tests for Phyllo::DisconnectAccountResponse1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::DisconnectAccountResponse1 do
  let(:instance) { Phyllo::DisconnectAccountResponse1.new }

  describe 'test an instance of DisconnectAccountResponse1' do
    it 'should create an instance of DisconnectAccountResponse1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::DisconnectAccountResponse1)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["CONNECTED", "NOT_CONNECTED", "SESSION_EXPIRED"])
