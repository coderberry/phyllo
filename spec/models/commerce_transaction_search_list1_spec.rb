...
# Unit tests for Phyllo::CommerceTransactionSearchList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceTransactionSearchList1 do
  let(:instance) { Phyllo::CommerceTransactionSearchList1.new }

  describe 'test an instance of CommerceTransactionSearchList1' do
    it 'should create an instance of CommerceTransactionSearchList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommerceTransactionSearchList1)
    end
  end
