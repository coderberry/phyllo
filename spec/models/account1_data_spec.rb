...
# Unit tests for Phyllo::Account1Data
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Account1Data do
  let(:instance) { Phyllo::Account1Data.new }

  describe 'test an instance of Account1Data' do
    it 'should create an instance of Account1Data' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Account1Data)
    end
  end
