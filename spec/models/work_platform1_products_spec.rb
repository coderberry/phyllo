...
# Unit tests for Phyllo::WorkPlatform1Products
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1Products do
  let(:instance) { Phyllo::WorkPlatform1Products.new }

  describe 'test an instance of WorkPlatform1Products' do
    it 'should create an instance of WorkPlatform1Products' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatform1Products)
    end
  end
