...
# Unit tests for Phyllo::WorkPlatform1ProductsIncome
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1ProductsIncome do
  let(:instance) { Phyllo::WorkPlatform1ProductsIncome.new }

  describe "test an instance of WorkPlatform1ProductsIncome" do
    it "should create an instance of WorkPlatform1ProductsIncome" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WorkPlatform1ProductsIncome)
    end
  end
