...
# Unit tests for Phyllo::DemographicsAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::DemographicsAttributes do
  let(:instance) { Phyllo::DemographicsAttributes.new }

  describe "test an instance of DemographicsAttributes" do
    it "should create an instance of DemographicsAttributes" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::DemographicsAttributes)
    end
  end
