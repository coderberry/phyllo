...
# Unit tests for Phyllo::CommerceTransactionSearchList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceTransactionSearchList do
  let(:instance) { Phyllo::CommerceTransactionSearchList.new }

  describe "test an instance of CommerceTransactionSearchList" do
    it "should create an instance of CommerceTransactionSearchList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceTransactionSearchList)
    end
  end
