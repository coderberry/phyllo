...
# Unit tests for Phyllo::WorkExperience1TimePeriod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkExperience1TimePeriod do
  let(:instance) { Phyllo::WorkExperience1TimePeriod.new }

  describe "test an instance of WorkExperience1TimePeriod" do
    it "should create an instance of WorkExperience1TimePeriod" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WorkExperience1TimePeriod)
    end
  end
