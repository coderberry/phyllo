...
# Unit tests for Phyllo::CommentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommentResponse do
  let(:instance) { Phyllo::CommentResponse.new }

  describe "test an instance of CommentResponse" do
    it "should create an instance of CommentResponse" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommentResponse)
    end
  end
