...
# Unit tests for Phyllo::Content1Sponsored
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Content1Sponsored do
  let(:instance) { Phyllo::Content1Sponsored.new }

  describe "test an instance of Content1Sponsored" do
    it "should create an instance of Content1Sponsored" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Content1Sponsored)
    end
  end

  describe 'test attribute "is_sponsored"' do
    it "should work" do
