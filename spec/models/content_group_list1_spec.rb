...
# Unit tests for Phyllo::ContentGroupList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroupList1 do
  let(:instance) { Phyllo::ContentGroupList1.new }

  describe "test an instance of ContentGroupList1" do
    it "should create an instance of ContentGroupList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentGroupList1)
    end
  end
