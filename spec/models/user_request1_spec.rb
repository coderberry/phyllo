...
# Unit tests for Phyllo::UserRequest1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::UserRequest1 do
  let(:instance) { Phyllo::UserRequest1.new }

  describe "test an instance of UserRequest1" do
    it "should create an instance of UserRequest1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::UserRequest1)
    end
  end
