...
# Unit tests for Phyllo::SocialTransaction1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SocialTransaction1 do
  let(:instance) { Phyllo::SocialTransaction1.new }

  describe 'test an instance of SocialTransaction1' do
    it 'should create an instance of SocialTransaction1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::SocialTransaction1)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["AD", "SUBSCRIPTION", "ADDITIONAL"])
