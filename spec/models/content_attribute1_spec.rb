...
# Unit tests for Phyllo::ContentAttribute1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentAttribute1 do
  let(:instance) { Phyllo::ContentAttribute1.new }

  describe "test an instance of ContentAttribute1" do
    it "should create an instance of ContentAttribute1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentAttribute1)
    end
  end
