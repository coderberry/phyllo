...
# Unit tests for Phyllo::WorkPlatform1ProductsSwitch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1ProductsSwitch do
  let(:instance) { Phyllo::WorkPlatform1ProductsSwitch.new }

  describe "test an instance of WorkPlatform1ProductsSwitch" do
    it "should create an instance of WorkPlatform1ProductsSwitch" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WorkPlatform1ProductsSwitch)
    end
  end
