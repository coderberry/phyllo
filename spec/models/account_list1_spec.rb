...
# Unit tests for Phyllo::AccountList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::AccountList1 do
  let(:instance) { Phyllo::AccountList1.new }

  describe "test an instance of AccountList1" do
    it "should create an instance of AccountList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::AccountList1)
    end
  end
