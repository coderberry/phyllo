...
# Unit tests for Phyllo::SocialTransactionSearch1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SocialTransactionSearch1 do
  let(:instance) { Phyllo::SocialTransactionSearch1.new }

  describe "test an instance of SocialTransactionSearch1" do
    it "should create an instance of SocialTransactionSearch1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SocialTransactionSearch1)
    end
  end
