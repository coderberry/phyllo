...
# Unit tests for Phyllo::DisconnectAccountResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::DisconnectAccountResponse do
  let(:instance) { Phyllo::DisconnectAccountResponse.new }

  describe "test an instance of DisconnectAccountResponse" do
    it "should create an instance of DisconnectAccountResponse" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::DisconnectAccountResponse)
    end
  end
