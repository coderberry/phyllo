...
# Unit tests for Phyllo::AccountAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::AccountAttribute do
  let(:instance) { Phyllo::AccountAttribute.new }

  describe "test an instance of AccountAttribute" do
    it "should create an instance of AccountAttribute" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::AccountAttribute)
    end
  end
