...
# Unit tests for Phyllo::ContentAttribute
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentAttribute do
  let(:instance) { Phyllo::ContentAttribute.new }

  describe 'test an instance of ContentAttribute' do
    it 'should create an instance of ContentAttribute' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ContentAttribute)
    end
  end
