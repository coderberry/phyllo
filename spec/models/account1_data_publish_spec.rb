...
# Unit tests for Phyllo::Account1DataPublish
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Account1DataPublish do
  let(:instance) { Phyllo::Account1DataPublish.new }

  describe 'test an instance of Account1DataPublish' do
    it 'should create an instance of Account1DataPublish' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Account1DataPublish)
    end
  end
