...
# Unit tests for Phyllo::Content1Collaboration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Content1Collaboration do
  let(:instance) { Phyllo::Content1Collaboration.new }

  describe 'test an instance of Content1Collaboration' do
    it 'should create an instance of Content1Collaboration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Content1Collaboration)
    end
  end

  describe 'test attribute "has_collaborators"' do
    it 'should work' do
