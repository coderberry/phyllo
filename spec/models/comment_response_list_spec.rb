...
# Unit tests for Phyllo::CommentResponseList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommentResponseList do
  let(:instance) { Phyllo::CommentResponseList.new }

  describe 'test an instance of CommentResponseList' do
    it 'should create an instance of CommentResponseList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommentResponseList)
    end
  end
