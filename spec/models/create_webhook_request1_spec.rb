...
# Unit tests for Phyllo::CreateWebhookRequest1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CreateWebhookRequest1 do
  let(:instance) { Phyllo::CreateWebhookRequest1.new }

  describe "test an instance of CreateWebhookRequest1" do
    it "should create an instance of CreateWebhookRequest1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CreateWebhookRequest1)
    end
  end
