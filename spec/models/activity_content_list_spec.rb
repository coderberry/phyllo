...
# Unit tests for Phyllo::ActivityContentList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityContentList do
  let(:instance) { Phyllo::ActivityContentList.new }

  describe "test an instance of ActivityContentList" do
    it "should create an instance of ActivityContentList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityContentList)
    end
  end
