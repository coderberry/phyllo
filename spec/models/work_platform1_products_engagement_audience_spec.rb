...
# Unit tests for Phyllo::WorkPlatform1ProductsEngagementAudience
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1ProductsEngagementAudience do
  let(:instance) { Phyllo::WorkPlatform1ProductsEngagementAudience.new }

  describe 'test an instance of WorkPlatform1ProductsEngagementAudience' do
    it 'should create an instance of WorkPlatform1ProductsEngagementAudience' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatform1ProductsEngagementAudience)
    end
  end
