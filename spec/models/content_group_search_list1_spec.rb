...
# Unit tests for Phyllo::ContentGroupSearchList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroupSearchList1 do
  let(:instance) { Phyllo::ContentGroupSearchList1.new }

  describe "test an instance of ContentGroupSearchList1" do
    it "should create an instance of ContentGroupSearchList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentGroupSearchList1)
    end
  end
