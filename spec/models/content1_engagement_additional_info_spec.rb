...
# Unit tests for Phyllo::Content1EngagementAdditionalInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Content1EngagementAdditionalInfo do
  let(:instance) { Phyllo::Content1EngagementAdditionalInfo.new }

  describe "test an instance of Content1EngagementAdditionalInfo" do
    it "should create an instance of Content1EngagementAdditionalInfo" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Content1EngagementAdditionalInfo)
    end
  end

  describe 'test attribute "followers_gained"' do
    it "should work" do
  ...
  describe 'test attribute "bio_link_clicked"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "story_navigation"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
