...
# Unit tests for Phyllo::SocialTransactionSearch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SocialTransactionSearch do
  let(:instance) { Phyllo::SocialTransactionSearch.new }

  describe 'test an instance of SocialTransactionSearch' do
    it 'should create an instance of SocialTransactionSearch' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::SocialTransactionSearch)
    end
  end
