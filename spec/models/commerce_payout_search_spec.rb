...
# Unit tests for Phyllo::CommercePayoutSearch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommercePayoutSearch do
  let(:instance) { Phyllo::CommercePayoutSearch.new }

  describe "test an instance of CommercePayoutSearch" do
    it "should create an instance of CommercePayoutSearch" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommercePayoutSearch)
    end
  end
