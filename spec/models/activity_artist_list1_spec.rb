...
# Unit tests for Phyllo::ActivityArtistList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityArtistList1 do
  let(:instance) { Phyllo::ActivityArtistList1.new }

  describe "test an instance of ActivityArtistList1" do
    it "should create an instance of ActivityArtistList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityArtistList1)
    end
  end
