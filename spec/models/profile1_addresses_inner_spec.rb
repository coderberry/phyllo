...
# Unit tests for Phyllo::Profile1AddressesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Profile1AddressesInner do
  let(:instance) { Phyllo::Profile1AddressesInner.new }

  describe 'test an instance of Profile1AddressesInner' do
    it 'should create an instance of Profile1AddressesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Profile1AddressesInner)
    end
  end
