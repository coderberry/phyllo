...
# Unit tests for Phyllo::ContentGroupList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroupList do
  let(:instance) { Phyllo::ContentGroupList.new }

  describe 'test an instance of ContentGroupList' do
    it 'should create an instance of ContentGroupList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ContentGroupList)
    end
  end
