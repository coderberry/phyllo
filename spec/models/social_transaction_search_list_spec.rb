...
# Unit tests for Phyllo::SocialTransactionSearchList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SocialTransactionSearchList do
  let(:instance) { Phyllo::SocialTransactionSearchList.new }

  describe "test an instance of SocialTransactionSearchList" do
    it "should create an instance of SocialTransactionSearchList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SocialTransactionSearchList)
    end
  end
