...
# Unit tests for Phyllo::WorkPlatform1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1 do
  let(:instance) { Phyllo::WorkPlatform1.new }

  describe "test an instance of WorkPlatform1" do
    it "should create an instance of WorkPlatform1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WorkPlatform1)
    end
  end
