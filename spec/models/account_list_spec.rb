...
# Unit tests for Phyllo::AccountList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::AccountList do
  let(:instance) { Phyllo::AccountList.new }

  describe 'test an instance of AccountList' do
    it 'should create an instance of AccountList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::AccountList)
    end
  end
