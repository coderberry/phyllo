...
# Unit tests for Phyllo::V1GetAudienceDemographics200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::V1GetAudienceDemographics200Response do
  let(:instance) { Phyllo::V1GetAudienceDemographics200Response.new }

  describe "test an instance of V1GetAudienceDemographics200Response" do
    it "should create an instance of V1GetAudienceDemographics200Response" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::V1GetAudienceDemographics200Response)
    end
  end
  ...
  describe 'test attribute "gender_age_distribution"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
