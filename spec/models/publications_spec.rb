...
# Unit tests for Phyllo::Publications
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Publications do
  let(:instance) { Phyllo::Publications.new }

  describe "test an instance of Publications" do
    it "should create an instance of Publications" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Publications)
    end
  end
