...
# Unit tests for Phyllo::ContentSearchList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentSearchList1 do
  let(:instance) { Phyllo::ContentSearchList1.new }

  describe "test an instance of ContentSearchList1" do
    it "should create an instance of ContentSearchList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentSearchList1)
    end
  end
