...
# Unit tests for Phyllo::CommerceTransaction1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceTransaction1 do
  let(:instance) { Phyllo::CommerceTransaction1.new }

  describe "test an instance of CommerceTransaction1" do
    it "should create an instance of CommerceTransaction1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceTransaction1)
    end
  end
  ...
  describe 'test attribute "type"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["SALE", "REFUND", "CANCELLED", "VOID", "OTHER"])
  ...
  describe 'test attribute "status"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["SUCCESS", "FAILURE", "PENDING", "OTHER"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "transaction_at"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
