...
# Unit tests for Phyllo::SDKTokenRequest1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SDKTokenRequest1 do
  let(:instance) { Phyllo::SDKTokenRequest1.new }

  describe "test an instance of SDKTokenRequest1" do
    it "should create an instance of SDKTokenRequest1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SDKTokenRequest1)
    end
  end
  ...
  describe 'test attribute "products"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["IDENTITY", "IDENTITY.AUDIENCE", "ENGAGEMENT", "ENGAGEMENT.AUDIENCE", "INCOME", "PUBLISH.CONTENT", "ACTIVITY"])
      # validator.allowable_values.each do |value|
      #   expect { instance.products = value }.not_to raise_error
      # end
    end
  end
end
