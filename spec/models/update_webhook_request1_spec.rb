...
# Unit tests for Phyllo::UpdateWebhookRequest1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::UpdateWebhookRequest1 do
  let(:instance) { Phyllo::UpdateWebhookRequest1.new }

  describe 'test an instance of UpdateWebhookRequest1' do
    it 'should create an instance of UpdateWebhookRequest1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::UpdateWebhookRequest1)
    end
  end
