...
# Unit tests for Phyllo::FetchHistoric1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::FetchHistoric1 do
  let(:instance) { Phyllo::FetchHistoric1.new }

  describe 'test an instance of FetchHistoric1' do
    it 'should create an instance of FetchHistoric1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::FetchHistoric1)
    end
  end
