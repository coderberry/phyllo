...
# Unit tests for Phyllo::CommerceTransactionList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceTransactionList do
  let(:instance) { Phyllo::CommerceTransactionList.new }

  describe "test an instance of CommerceTransactionList" do
    it "should create an instance of CommerceTransactionList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceTransactionList)
    end
  end
