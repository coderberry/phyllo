...
# Unit tests for Phyllo::Refresh
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Refresh do
  let(:instance) { Phyllo::Refresh.new }

  describe "test an instance of Refresh" do
    it "should create an instance of Refresh" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Refresh)
    end
  end
