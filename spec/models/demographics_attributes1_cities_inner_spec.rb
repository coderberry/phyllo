...
# Unit tests for Phyllo::DemographicsAttributes1CitiesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::DemographicsAttributes1CitiesInner do
  let(:instance) { Phyllo::DemographicsAttributes1CitiesInner.new }

  describe 'test an instance of DemographicsAttributes1CitiesInner' do
    it 'should create an instance of DemographicsAttributes1CitiesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::DemographicsAttributes1CitiesInner)
    end
  end
