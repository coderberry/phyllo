...
# Unit tests for Phyllo::SocialTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SocialTransaction do
  let(:instance) { Phyllo::SocialTransaction.new }

  describe 'test an instance of SocialTransaction' do
    it 'should create an instance of SocialTransaction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::SocialTransaction)
    end
  end
