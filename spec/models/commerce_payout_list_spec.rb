...
# Unit tests for Phyllo::CommercePayoutList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommercePayoutList do
  let(:instance) { Phyllo::CommercePayoutList.new }

  describe 'test an instance of CommercePayoutList' do
    it 'should create an instance of CommercePayoutList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommercePayoutList)
    end
  end
