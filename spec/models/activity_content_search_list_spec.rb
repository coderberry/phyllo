...
# Unit tests for Phyllo::ActivityContentSearchList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityContentSearchList do
  let(:instance) { Phyllo::ActivityContentSearchList.new }

  describe "test an instance of ActivityContentSearchList" do
    it "should create an instance of ActivityContentSearchList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityContentSearchList)
    end
  end
