...
# Unit tests for Phyllo::PublishContentRequest1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PublishContentRequest1 do
  let(:instance) { Phyllo::PublishContentRequest1.new }

  describe "test an instance of PublishContentRequest1" do
    it "should create an instance of PublishContentRequest1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::PublishContentRequest1)
    end
  end
