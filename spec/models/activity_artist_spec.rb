...
# Unit tests for Phyllo::ActivityArtist
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityArtist do
  let(:instance) { Phyllo::ActivityArtist.new }

  describe 'test an instance of ActivityArtist' do
    it 'should create an instance of ActivityArtist' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ActivityArtist)
    end
  end
