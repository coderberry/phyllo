...
# Unit tests for Phyllo::ProfileList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ProfileList do
  let(:instance) { Phyllo::ProfileList.new }

  describe "test an instance of ProfileList" do
    it "should create an instance of ProfileList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ProfileList)
    end
  end
