...
# Unit tests for Phyllo::Certifications1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Certifications1 do
  let(:instance) { Phyllo::Certifications1.new }

  describe "test an instance of Certifications1" do
    it "should create an instance of Certifications1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Certifications1)
    end
  end
