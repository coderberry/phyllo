...
# Unit tests for Phyllo::Profile1PhoneNumbersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Profile1PhoneNumbersInner do
  let(:instance) { Phyllo::Profile1PhoneNumbersInner.new }

  describe "test an instance of Profile1PhoneNumbersInner" do
    it "should create an instance of Profile1PhoneNumbersInner" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Profile1PhoneNumbersInner)
    end
  end
  ...
  describe 'test attribute "type"' do
    it "should work" do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["WORK", "OTHER", "HOME"])
