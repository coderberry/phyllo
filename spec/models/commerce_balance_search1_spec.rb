...
# Unit tests for Phyllo::CommerceBalanceSearch1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalanceSearch1 do
  let(:instance) { Phyllo::CommerceBalanceSearch1.new }

  describe "test an instance of CommerceBalanceSearch1" do
    it "should create an instance of CommerceBalanceSearch1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceBalanceSearch1)
    end
  end
