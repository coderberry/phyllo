...
# Unit tests for Phyllo::UserResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::UserResponse do
  let(:instance) { Phyllo::UserResponse.new }

  describe 'test an instance of UserResponse' do
    it 'should create an instance of UserResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::UserResponse)
    end
  end
