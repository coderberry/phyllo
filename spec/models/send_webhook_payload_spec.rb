...
# Unit tests for Phyllo::SendWebhookPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SendWebhookPayload do
  let(:instance) { Phyllo::SendWebhookPayload.new }

  describe "test an instance of SendWebhookPayload" do
    it "should create an instance of SendWebhookPayload" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SendWebhookPayload)
    end
  end
