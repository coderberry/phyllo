...
# Unit tests for Phyllo::CommerceBalanceSearch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalanceSearch do
  let(:instance) { Phyllo::CommerceBalanceSearch.new }

  describe "test an instance of CommerceBalanceSearch" do
    it "should create an instance of CommerceBalanceSearch" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceBalanceSearch)
    end
  end
