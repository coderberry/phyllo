...
# Unit tests for Phyllo::WorkPlatformList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatformList do
  let(:instance) { Phyllo::WorkPlatformList.new }

  describe 'test an instance of WorkPlatformList' do
    it 'should create an instance of WorkPlatformList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatformList)
    end
  end
