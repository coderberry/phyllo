...
# Unit tests for Phyllo::ContentGroupSearchList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroupSearchList do
  let(:instance) { Phyllo::ContentGroupSearchList.new }

  describe "test an instance of ContentGroupSearchList" do
    it "should create an instance of ContentGroupSearchList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentGroupSearchList)
    end
  end
