...
# Unit tests for Phyllo::CommercePayoutList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommercePayoutList1 do
  let(:instance) { Phyllo::CommercePayoutList1.new }

  describe "test an instance of CommercePayoutList1" do
    it "should create an instance of CommercePayoutList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommercePayoutList1)
    end
  end
