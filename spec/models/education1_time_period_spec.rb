...
# Unit tests for Phyllo::Education1TimePeriod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Education1TimePeriod do
  let(:instance) { Phyllo::Education1TimePeriod.new }

  describe "test an instance of Education1TimePeriod" do
    it "should create an instance of Education1TimePeriod" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Education1TimePeriod)
    end
  end
