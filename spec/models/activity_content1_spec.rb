...
# Unit tests for Phyllo::ActivityContent1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityContent1 do
  let(:instance) { Phyllo::ActivityContent1.new }

  describe "test an instance of ActivityContent1" do
    it "should create an instance of ActivityContent1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityContent1)
    end
  end
