...
# Unit tests for Phyllo::SocialTransactionList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::SocialTransactionList1 do
  let(:instance) { Phyllo::SocialTransactionList1.new }

  describe "test an instance of SocialTransactionList1" do
    it "should create an instance of SocialTransactionList1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::SocialTransactionList1)
    end
  end
