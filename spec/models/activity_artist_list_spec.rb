...
# Unit tests for Phyllo::ActivityArtistList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityArtistList do
  let(:instance) { Phyllo::ActivityArtistList.new }

  describe 'test an instance of ActivityArtistList' do
    it 'should create an instance of ActivityArtistList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ActivityArtistList)
    end
  end
