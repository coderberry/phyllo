...
# Unit tests for Phyllo::ActivityContentSearch1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityContentSearch1 do
  let(:instance) { Phyllo::ActivityContentSearch1.new }

  describe "test an instance of ActivityContentSearch1" do
    it "should create an instance of ActivityContentSearch1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityContentSearch1)
    end
  end
