...
# Unit tests for Phyllo::Honors1Date
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Honors1Date do
  let(:instance) { Phyllo::Honors1Date.new }

  describe 'test an instance of Honors1Date' do
    it 'should create an instance of Honors1Date' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Honors1Date)
    end
  end
