...
# Unit tests for Phyllo::Projects1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Projects1 do
  let(:instance) { Phyllo::Projects1.new }

  describe 'test an instance of Projects1' do
    it 'should create an instance of Projects1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Projects1)
    end
  end
