...
# Unit tests for Phyllo::CommerceBalanceAmount1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalanceAmount1 do
  let(:instance) { Phyllo::CommerceBalanceAmount1.new }

  describe "test an instance of CommerceBalanceAmount1" do
    it "should create an instance of CommerceBalanceAmount1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceBalanceAmount1)
    end
  end
