...
# Unit tests for Phyllo::ContentList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentList do
  let(:instance) { Phyllo::ContentList.new }

  describe "test an instance of ContentList" do
    it "should create an instance of ContentList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentList)
    end
  end
