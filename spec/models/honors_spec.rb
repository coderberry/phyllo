...
# Unit tests for Phyllo::Honors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Honors do
  let(:instance) { Phyllo::Honors.new }

  describe 'test an instance of Honors' do
    it 'should create an instance of Honors' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Honors)
    end
  end
