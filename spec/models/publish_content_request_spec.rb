...
# Unit tests for Phyllo::PublishContentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PublishContentRequest do
  let(:instance) { Phyllo::PublishContentRequest.new }

  describe "test an instance of PublishContentRequest" do
    it "should create an instance of PublishContentRequest" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::PublishContentRequest)
    end
  end
