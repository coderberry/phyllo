...
# Unit tests for Phyllo::CommerceTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceTransaction do
  let(:instance) { Phyllo::CommerceTransaction.new }

  describe "test an instance of CommerceTransaction" do
    it "should create an instance of CommerceTransaction" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceTransaction)
    end
  end
