...
# Unit tests for Phyllo::ActivityArtistSearchList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityArtistSearchList do
  let(:instance) { Phyllo::ActivityArtistSearchList.new }

  describe "test an instance of ActivityArtistSearchList" do
    it "should create an instance of ActivityArtistSearchList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityArtistSearchList)
    end
  end
