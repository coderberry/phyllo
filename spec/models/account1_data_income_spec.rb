...
# Unit tests for Phyllo::Account1DataIncome
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Account1DataIncome do
  let(:instance) { Phyllo::Account1DataIncome.new }

  describe 'test an instance of Account1DataIncome' do
    it 'should create an instance of Account1DataIncome' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Account1DataIncome)
    end
  end
