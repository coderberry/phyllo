...
# Unit tests for Phyllo::WebhookPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WebhookPayload do
  let(:instance) { Phyllo::WebhookPayload.new }

  describe "test an instance of WebhookPayload" do
    it "should create an instance of WebhookPayload" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WebhookPayload)
    end
  end
