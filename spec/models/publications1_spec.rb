...
# Unit tests for Phyllo::Publications1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Publications1 do
  let(:instance) { Phyllo::Publications1.new }

  describe 'test an instance of Publications1' do
    it 'should create an instance of Publications1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Publications1)
    end
  end
