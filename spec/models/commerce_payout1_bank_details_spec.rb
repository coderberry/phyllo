...
# Unit tests for Phyllo::CommercePayout1BankDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommercePayout1BankDetails do
  let(:instance) { Phyllo::CommercePayout1BankDetails.new }

  describe 'test an instance of CommercePayout1BankDetails' do
    it 'should create an instance of CommercePayout1BankDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommercePayout1BankDetails)
    end
  end
  ...
  describe 'test attribute "account_last_digits"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
