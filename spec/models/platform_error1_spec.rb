...
# Unit tests for Phyllo::PlatformError1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PlatformError1 do
  let(:instance) { Phyllo::PlatformError1.new }

  describe "test an instance of PlatformError1" do
    it "should create an instance of PlatformError1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::PlatformError1)
    end
  end
