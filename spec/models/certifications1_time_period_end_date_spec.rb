...
# Unit tests for Phyllo::Certifications1TimePeriodEndDate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Certifications1TimePeriodEndDate do
  let(:instance) { Phyllo::Certifications1TimePeriodEndDate.new }

  describe "test an instance of Certifications1TimePeriodEndDate" do
    it "should create an instance of Certifications1TimePeriodEndDate" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Certifications1TimePeriodEndDate)
    end
  end
