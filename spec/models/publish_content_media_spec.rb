...
# Unit tests for Phyllo::PublishContentMedia
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PublishContentMedia do
  let(:instance) { Phyllo::PublishContentMedia.new }

  describe "test an instance of PublishContentMedia" do
    it "should create an instance of PublishContentMedia" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::PublishContentMedia)
    end
  end
