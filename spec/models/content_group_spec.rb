...
# Unit tests for Phyllo::ContentGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentGroup do
  let(:instance) { Phyllo::ContentGroup.new }

  describe 'test an instance of ContentGroup' do
    it 'should create an instance of ContentGroup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ContentGroup)
    end
  end
