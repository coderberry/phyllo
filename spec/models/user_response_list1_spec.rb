...
# Unit tests for Phyllo::UserResponseList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::UserResponseList1 do
  let(:instance) { Phyllo::UserResponseList1.new }

  describe 'test an instance of UserResponseList1' do
    it 'should create an instance of UserResponseList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::UserResponseList1)
    end
  end
