...
# Unit tests for Phyllo::CommercePayoutSearchList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommercePayoutSearchList1 do
  let(:instance) { Phyllo::CommercePayoutSearchList1.new }

  describe 'test an instance of CommercePayoutSearchList1' do
    it 'should create an instance of CommercePayoutSearchList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommercePayoutSearchList1)
    end
  end
