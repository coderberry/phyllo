...
# Unit tests for Phyllo::CommerceTransactionList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceTransactionList1 do
  let(:instance) { Phyllo::CommerceTransactionList1.new }

  describe 'test an instance of CommerceTransactionList1' do
    it 'should create an instance of CommerceTransactionList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommerceTransactionList1)
    end
  end
