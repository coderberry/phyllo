...
# Unit tests for Phyllo::WorkExperience1TimePeriodEndDate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkExperience1TimePeriodEndDate do
  let(:instance) { Phyllo::WorkExperience1TimePeriodEndDate.new }

  describe 'test an instance of WorkExperience1TimePeriodEndDate' do
    it 'should create an instance of WorkExperience1TimePeriodEndDate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkExperience1TimePeriodEndDate)
    end
  end
