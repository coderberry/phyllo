...
# Unit tests for Phyllo::WorkExperience
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkExperience do
  let(:instance) { Phyllo::WorkExperience.new }

  describe "test an instance of WorkExperience" do
    it "should create an instance of WorkExperience" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WorkExperience)
    end
  end
