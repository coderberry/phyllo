...
# Unit tests for Phyllo::ContentSearchList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentSearchList do
  let(:instance) { Phyllo::ContentSearchList.new }

  describe "test an instance of ContentSearchList" do
    it "should create an instance of ContentSearchList" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentSearchList)
    end
  end
