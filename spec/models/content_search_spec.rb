...
# Unit tests for Phyllo::ContentSearch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ContentSearch do
  let(:instance) { Phyllo::ContentSearch.new }

  describe "test an instance of ContentSearch" do
    it "should create an instance of ContentSearch" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ContentSearch)
    end
  end
