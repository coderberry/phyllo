...
# Unit tests for Phyllo::CommerceBalance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalance do
  let(:instance) { Phyllo::CommerceBalance.new }

  describe "test an instance of CommerceBalance" do
    it "should create an instance of CommerceBalance" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceBalance)
    end
  end
