...
# Unit tests for Phyllo::UserAttribute1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::UserAttribute1 do
  let(:instance) { Phyllo::UserAttribute1.new }

  describe 'test an instance of UserAttribute1' do
    it 'should create an instance of UserAttribute1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::UserAttribute1)
    end
  end
