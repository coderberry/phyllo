...
# Unit tests for Phyllo::WebhookResponseList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WebhookResponseList1 do
  let(:instance) { Phyllo::WebhookResponseList1.new }

  describe 'test an instance of WebhookResponseList1' do
    it 'should create an instance of WebhookResponseList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WebhookResponseList1)
    end
  end
