...
# Unit tests for Phyllo::WorkExperience1Location
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkExperience1Location do
  let(:instance) { Phyllo::WorkExperience1Location.new }

  describe "test an instance of WorkExperience1Location" do
    it "should create an instance of WorkExperience1Location" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WorkExperience1Location)
    end
  end
