...
# Unit tests for Phyllo::PlatformError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::PlatformError do
  let(:instance) { Phyllo::PlatformError.new }

  describe "test an instance of PlatformError" do
    it "should create an instance of PlatformError" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::PlatformError)
    end
  end
