...
# Unit tests for Phyllo::CommerceBalance1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalance1 do
  let(:instance) { Phyllo::CommerceBalance1.new }

  describe "test an instance of CommerceBalance1" do
    it "should create an instance of CommerceBalance1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceBalance1)
    end
  end
  ...
  describe 'test attribute "balance_at"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
