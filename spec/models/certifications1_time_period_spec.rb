...
# Unit tests for Phyllo::Certifications1TimePeriod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Certifications1TimePeriod do
  let(:instance) { Phyllo::Certifications1TimePeriod.new }

  describe 'test an instance of Certifications1TimePeriod' do
    it 'should create an instance of Certifications1TimePeriod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Certifications1TimePeriod)
    end
  end
