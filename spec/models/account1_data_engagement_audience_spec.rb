...
# Unit tests for Phyllo::Account1DataEngagementAudience
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Account1DataEngagementAudience do
  let(:instance) { Phyllo::Account1DataEngagementAudience.new }

  describe "test an instance of Account1DataEngagementAudience" do
    it "should create an instance of Account1DataEngagementAudience" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Account1DataEngagementAudience)
    end
  end
