...
# Unit tests for Phyllo::CommerceBalanceList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceBalanceList do
  let(:instance) { Phyllo::CommerceBalanceList.new }

  describe 'test an instance of CommerceBalanceList' do
    it 'should create an instance of CommerceBalanceList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommerceBalanceList)
    end
  end
