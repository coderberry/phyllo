...
# Unit tests for Phyllo::CommerceTransactionSearch1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommerceTransactionSearch1 do
  let(:instance) { Phyllo::CommerceTransactionSearch1.new }

  describe "test an instance of CommerceTransactionSearch1" do
    it "should create an instance of CommerceTransactionSearch1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::CommerceTransactionSearch1)
    end
  end
