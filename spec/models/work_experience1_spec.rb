...
# Unit tests for Phyllo::WorkExperience1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkExperience1 do
  let(:instance) { Phyllo::WorkExperience1.new }

  describe 'test an instance of WorkExperience1' do
    it 'should create an instance of WorkExperience1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkExperience1)
    end
  end
