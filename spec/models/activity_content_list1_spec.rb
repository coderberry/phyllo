...
# Unit tests for Phyllo::ActivityContentList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityContentList1 do
  let(:instance) { Phyllo::ActivityContentList1.new }

  describe 'test an instance of ActivityContentList1' do
    it 'should create an instance of ActivityContentList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ActivityContentList1)
    end
  end
