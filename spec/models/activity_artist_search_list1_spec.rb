...
# Unit tests for Phyllo::ActivityArtistSearchList1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityArtistSearchList1 do
  let(:instance) { Phyllo::ActivityArtistSearchList1.new }

  describe 'test an instance of ActivityArtistSearchList1' do
    it 'should create an instance of ActivityArtistSearchList1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::ActivityArtistSearchList1)
    end
  end
