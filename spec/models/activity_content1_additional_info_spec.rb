...
# Unit tests for Phyllo::ActivityContent1AdditionalInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityContent1AdditionalInfo do
  let(:instance) { Phyllo::ActivityContent1AdditionalInfo.new }

  describe "test an instance of ActivityContent1AdditionalInfo" do
    it "should create an instance of ActivityContent1AdditionalInfo" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityContent1AdditionalInfo)
    end
  end
  ...
  describe 'test attribute "artists"' do
    it "should work" do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
