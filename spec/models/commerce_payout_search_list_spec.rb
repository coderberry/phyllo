...
# Unit tests for Phyllo::CommercePayoutSearchList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::CommercePayoutSearchList do
  let(:instance) { Phyllo::CommercePayoutSearchList.new }

  describe 'test an instance of CommercePayoutSearchList' do
    it 'should create an instance of CommercePayoutSearchList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::CommercePayoutSearchList)
    end
  end
