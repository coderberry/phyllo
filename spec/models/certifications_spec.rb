...
# Unit tests for Phyllo::Certifications
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Certifications do
  let(:instance) { Phyllo::Certifications.new }

  describe "test an instance of Certifications" do
    it "should create an instance of Certifications" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Certifications)
    end
  end
