...
# Unit tests for Phyllo::Publications1Date
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Publications1Date do
  let(:instance) { Phyllo::Publications1Date.new }

  describe "test an instance of Publications1Date" do
    it "should create an instance of Publications1Date" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Publications1Date)
    end
  end
