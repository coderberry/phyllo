...
# Unit tests for Phyllo::Content1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Content1 do
  let(:instance) { Phyllo::Content1.new }

  describe "test an instance of Content1" do
    it "should create an instance of Content1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::Content1)
    end
  end
