...
# Unit tests for Phyllo::Honors1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::Honors1 do
  let(:instance) { Phyllo::Honors1.new }

  describe 'test an instance of Honors1' do
    it 'should create an instance of Honors1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::Honors1)
    end
  end
