...
# Unit tests for Phyllo::ActivityArtistSearch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::ActivityArtistSearch do
  let(:instance) { Phyllo::ActivityArtistSearch.new }

  describe "test an instance of ActivityArtistSearch" do
    it "should create an instance of ActivityArtistSearch" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::ActivityArtistSearch)
    end
  end
