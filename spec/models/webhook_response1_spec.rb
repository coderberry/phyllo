...
# Unit tests for Phyllo::WebhookResponse1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WebhookResponse1 do
  let(:instance) { Phyllo::WebhookResponse1.new }

  describe "test an instance of WebhookResponse1" do
    it "should create an instance of WebhookResponse1" do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Phyllo::WebhookResponse1)
    end
  end
