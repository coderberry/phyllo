...
# Unit tests for Phyllo::WorkPlatform1ProductsActivity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Phyllo::WorkPlatform1ProductsActivity do
  let(:instance) { Phyllo::WorkPlatform1ProductsActivity.new }

  describe 'test an instance of WorkPlatform1ProductsActivity' do
    it 'should create an instance of WorkPlatform1ProductsActivity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Phyllo::WorkPlatform1ProductsActivity)
    end
  end
