...
module Phyllo
  ...
  class PublishContentMedia2
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'source_media_url')
        self.source_media_url = attributes[:'source_media_url']
      else
        self.source_media_url = nil
      end
      ...
      if attributes.key?(:'thumbnail_offset')
        self.thumbnail_offset = attributes[:'thumbnail_offset']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          source_thumbnail_url == o.source_thumbnail_url &&
          thumbnail_offset == o.thumbnail_offset &&
