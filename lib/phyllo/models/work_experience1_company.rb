...
module Phyllo
  ...
  class WorkExperience1Company
    # Company name
    attr_accessor :name

    # Industry tags of the company
    ...
    def self.openapi_types
      {
        ...
        logo_url: :String,
        employee_count: :WorkExperience1CompanyEmployeeCount
      }
    end
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Phyllo::WorkExperience1Company` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Phyllo::WorkExperience1Company`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(other)
      ...
      self.class == other.class &&
        ...
        employee_count == other.employee_count
    end
    ...
    def hash
      [name, industries, logo_url, employee_count].hash
    end
