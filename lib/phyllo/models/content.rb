  ...
  class Content
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Phyllo::Content` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Phyllo::Content`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_owned_by_platform_user')
        self.is_owned_by_platform_user = attributes[:'is_owned_by_platform_user']
      else
        self.is_owned_by_platform_user = true
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          persistent_thumbnail_url == o.persistent_thumbnail_url &&
          ...
          audience == o.audience &&
          platform == o.platform &&
          content_tags == o.content_tags &&
          sponsored == o.sponsored &&
          collaboration == o.collaboration &&
          is_owned_by_platform_user == o.is_owned_by_platform_user
    end
