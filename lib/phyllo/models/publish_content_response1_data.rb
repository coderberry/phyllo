...
module Phyllo
  class PublishContentResponse1Data
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["READY", "SUCCESS", "FAILURE", "IN_PROGRESS"])
    ...
    def format=(format)
      validator = EnumAttributeValidator.new('String', ["VIDEO", "AUDIO", "IMAGE", "TEXT", "COLLECTION"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status == o.status &&
          format == o.format &&
          published_info == o.published_info &&
          title == o.title &&
    ...
    def hash
      [id, user, account, work_platform, status, format, published_info, title, description, type, visibility, _retry, additional_info, media].hash
    end
