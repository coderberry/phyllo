  ...
  class Profile1
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Phyllo::Profile1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Phyllo::Profile1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          platform_account_type == o.platform_account_type &&
          category == o.category &&
          website == o.website &&
          ...
          platform_profile_published_at == o.platform_profile_published_at &&
          is_verified == o.is_verified &&
          is_business == o.is_business &&
          work_experiences == o.work_experiences &&
          education == o.education &&
          publications == o.publications &&
          certifications == o.certifications &&
          volunteer_experiences == o.volunteer_experiences &&
          honors == o.honors &&
          projects == o.projects
    end
